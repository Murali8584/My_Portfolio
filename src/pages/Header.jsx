...
const Header = () => {
  ...
  return (
    ...
    >
      ...
      <div className="container min-h-screen pt-[120px] overflow-visible">
        <div className="grid grid-cols-[400px_auto] gap-8 relative z-10 pb-8">
          <div className="me" ref={meRef}>
            <img src="/assets/me.png" alt="Murali M" className="max-md:order-2 max-md:max-w-[400px] max-md:mx-auto" />
          </div>
          <div className="user__info max-md:order-1" ref={userInfoRef}>
            <h2 className="sub__title max-md:text-center">Hi 👋, I'm Murali</h2>
            <h1 className="title max-md:text-center" ref={titleRef}>Full Stack Mobile Developer</h1>
            <p className="text-lg leading-[25px] max-md:text-center">
            ...
            <div className="flex buttons items-center gap-5 my-8 max-md:justify-center max-md:flex-col" ref={buttonsRef}>
          ...
          <div 
            className="points absolute bottom-0 left-0 w-full z-20 grid grid-cols-4 gap-4 p-8 backdrop-blur-[50px] rounded-xl max-md:grid-cols-2 max-md:justify-items-center shadow-lg" 
          ...
          >
            ...
            <div className="point" ref={el => pointRefs.current[0] = el}>
              <div className="flex items-center gap-1.5 max-md:justify-center">
                <div className="odometer sub__title" id="experience" ref={experienceRef}></div>
                <h3 className="sub__title">+</h3>
              </div>
              <p className="text__muted text-[10px] max-md:text-center">Years Of Experience</p>
            </div>
            <div className="point" ref={el => pointRefs.current[1] = el}>
              <div className="flex items-center gap-1.5 max-md:justify-center">
                <div className="odometer sub__title" id="project" ref={projectRef}></div>
                <h3 className="sub__title">+</h3>
              </div>
              <p className="text__muted text-[10px] max-md:text-center">Completed projects</p>
            </div>
            <div className="point" ref={el => pointRefs.current[2] = el}>
              <div className="flex items-center gap-1.5 max-md:justify-center">
                <div className="odometer sub__title" id="awards" ref={awardsRef}></div>
                <h3 className="sub__title">🏆+</h3>
              </div>
              <p className="text__muted text-[10px] max-md:text-center">Major Projects</p>
            </div>
            <div className="point" ref={el => pointRefs.current[3] = el}>
              <div className="flex items-center gap-1.5 max-md:justify-center">
                <div className="odometer sub__title" id="clients" ref={clientsRef}></div>
                <h3 className="sub__title">+</h3>
              </div>
              <p className="text__muted text-[10px] max-md:text-center">Companies Worked</p>
            </div>
          </div>
        </div>
      </div>
